...
const showProductTag = document.getElementsByClassName("showProduct")[0];
...
const navigateAndSelectProduct = (key) => {
  if (key === "ArrowDown") {
    ...
    const enterProduct = selectedProduct(indexToSelect);
    delectProduct();
    const showText = document.createElement("div");
    showText.classList.add("showText");
    showText.append("This is the item you choose!");
    showProductTag.append(showText, enterProduct);
  }
};
...
const selectedProduct = (index) => {
  ...
  productContainerToSelect.style.backgroundColor = "blue";
